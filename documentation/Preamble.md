...
**What this lecture is?** A *practical* reminder of python together with some of the most important data analysis tools namely `numpy`, `matplotlib` and `pandas`.
